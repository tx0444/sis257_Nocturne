...
class CreateCategoriaDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { nombre: { required: true, type: () => String }, descripcion: { required: false, type: () => String }, imagenUrl: { required: false, type: () => String } };
    }
}
...
class UpdateCategoriaDto extends (0, swagger_1.PartialType)(CreateCategoriaDto) {
    activo;
    static _OPENAPI_METADATA_FACTORY() {
