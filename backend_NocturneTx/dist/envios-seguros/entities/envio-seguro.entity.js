...
let EnvioSeguro = class EnvioSeguro {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, venta: { required: true, type: () => require("../../ventas/entities/venta.entity").Venta }, ventaId: { required: true, type: () => Number }, agenteAsignado: { required: true, type: () => String }, latitudActual: { required: true, type: () => Number }, longitudActual: { required: true, type: () => Number }, temperaturaConvoy: { required: true, type: () => Number }, humedadConvoy: { required: true, type: () => Number }, progresoPorcentaje: { required: true, type: () => Number }, estadoLogistico: { required: true, type: () => String }, fechaInicio: { required: true, type: () => Date }, updatedAt: { required: true, type: () => Date } };
    }
};
