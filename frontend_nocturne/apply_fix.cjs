...
// 2. Redesign Hero
let newHero = \    <!-- SECCI�N 1 - VIDEO HERO PRINCIPAL -->
        ...
        <div class="row">
          <div class="col-lg-8 fade-in-up">
            ...
            <p class="lead text-secondary mb-5" style="max-width: 550px; font-size: 1.05rem; line-height: 1.6;">
              Descubre la selecci�n m�s exclusiva de licores nacionales e importados. Una b�veda climatizada que garantiza la m�xima calidad para tus celebraciones.
            </p>
            ...
            <div class="d-flex flex-wrap gap-3 mt-2">
              ...
              <a href="#tienda" class="btn btn-outline-glass px-5 py-3 d-flex align-items-center gap-2 text-decoration-none">
                <span class="fw-semibold text-white" style="letter-spacing: 1px;">VER CAT�LOGO</span>
...
let regexHero = /<!-- SECCI�N 1 - VIDEO HERO PRINCIPAL -->[\\s\\S]*?<\/header>/;
