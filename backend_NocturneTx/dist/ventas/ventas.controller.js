...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Crear venta (usuario autenticado)' }),
    openapi.ApiResponse({ status: 201, type: require("./entities/venta.entity").Venta }),
...
__decorate([
    ...
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listar ventas (admin/vendedor)' }),
    openapi.ApiResponse({ status: 200, type: [require("./entities/venta.entity").Venta] }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Ventas por rango de fechas (admin/vendedor)' }),
    openapi.ApiResponse({ status: 200, type: [require("./entities/venta.entity").Venta] }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Estadísticas de ventas (admin/vendedor)' }),
...
__decorate([
    (0, roles_decorator_1.Roles)(constants_1.ROLE_ADMIN, constants_1.ROLE_VENDEDOR),
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Detalle de venta (admin/vendedor)' }),
    openapi.ApiResponse({ status: 200, type: require("./entities/venta.entity").Venta }),
...
__decorate([
    (0, roles_decorator_1.Roles)(constants_1.ROLE_ADMIN, constants_1.ROLE_VENDEDOR),
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Actualizar venta (admin/vendedor)' }),
    openapi.ApiResponse({ status: 200, type: require("./entities/venta.entity").Venta }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Cancelar venta (admin/vendedor)' }),
    openapi.ApiResponse({ status: 200, type: require("./entities/venta.entity").Venta }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Eliminar venta (admin)' }),
