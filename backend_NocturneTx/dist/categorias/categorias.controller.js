...
__decorate([
    ...
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Crear categoría (admin)' }),
    openapi.ApiResponse({ status: 201, type: require("./entities/categorias.entity").Categoria }),
...
__decorate([
    ...
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listar categorías (público)' }),
    openapi.ApiResponse({ status: 200, type: [require("./entities/categorias.entity").Categoria] }),
    __metadata("design:type", Function),
...
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.Get)('conteo'),
    (0, swagger_1.ApiOperation)({ summary: 'Conteo de productos por categoría (público)' }),
    openapi.ApiResponse({ status: 200, type: [Object] }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], CategoriasController.prototype, "getConteoProductos", null);
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.Get)('nombre/:nombre'),
    (0, swagger_1.ApiOperation)({ summary: 'Buscar categoría por nombre (público)' }),
    openapi.ApiResponse({ status: 200, type: Object }),
    __param(0, (0, common_1.Param)('nombre')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], CategoriasController.prototype, "findByNombre", null);
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Detalle de categoría (público)' }),
    openapi.ApiResponse({ status: 200, type: require("./entities/categorias.entity").Categoria }),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Actualizar categoría (admin)' }),
    openapi.ApiResponse({ status: 200, type: require("./entities/categorias.entity").Categoria }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Eliminar categoría (admin)' }),
