...
let MetodoPago = class MetodoPago {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, nombre: { required: true, type: () => String }, tipo: { required: true, enum: require("./metodo-pago.entity").TipoMetodo }, descripcion: { required: true, type: () => String }, comisionPorcentaje: { required: true, type: () => Number }, comisionFija: { required: true, type: () => Number }, tiempoConfirmacion: { required: true, type: () => String }, requiereVerificacion: { required: true, type: () => Boolean }, permiteParcial: { required: true, type: () => Boolean }, activo: { required: true, type: () => Boolean }, estado: { required: true, enum: require("./metodo-pago.entity").EstadoMetodoPago }, createdAt: { required: true, type: () => Date }, updatedAt: { required: true, type: () => Date } };
    }
};
