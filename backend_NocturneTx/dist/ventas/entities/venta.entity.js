...
let Venta = class Venta {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, numeroFactura: { required: true, type: () => String }, subtotal: { required: true, type: () => Number }, descuento: { required: true, type: () => Number }, impuesto: { required: true, type: () => Number }, total: { required: true, type: () => Number }, montoEntregado: { required: true, type: () => Number }, cambioDevuelto: { required: true, type: () => Number }, metodoPago: { required: true, enum: require("./venta.entity").MetodoPago }, estado: { required: true, enum: require("./venta.entity").EstadoVenta }, serie: { required: true, type: () => String }, numeroAutorizacion: { required: true, type: () => String }, observaciones: { required: true, type: () => String }, fechaVenta: { required: true, type: () => Date }, createdAt: { required: true, type: () => Date }, updatedAt: { required: true, type: () => Date }, cliente: { required: true, type: () => require("../../clientes/entities/cliente.entity").Cliente }, clienteId: { required: true, type: () => Number }, usuario: { required: true, type: () => require("../../usuarios/entities/usuario.entity").Usuario }, usuarioId: { required: true, type: () => Number }, detalles: { required: true, type: () => [require("../../detalles-venta/entities/detalle-venta.entity").DetalleVenta] }, movimientos: { required: true, type: () => [require("../../movimientos-inventario/entities/movimiento-inventario.entity").MovimientoInventario] }, tipoEntrega: { required: true, enum: require("./venta.entity").TipoEntrega }, direccionEntrega: { required: true, type: () => String }, telefonoEntrega: { required: true, type: () => String }, referenciaEntrega: { required: true, type: () => String } };
    }
};
exports.Venta = Venta;
__decorate([
