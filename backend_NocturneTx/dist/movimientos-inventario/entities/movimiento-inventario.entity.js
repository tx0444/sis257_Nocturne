...
let MovimientoInventario = class MovimientoInventario {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, tipo: { required: true, enum: require("./movimiento-inventario.entity").TipoMovimiento }, cantidad: { required: true, type: () => Number }, cantidadAntes: { required: true, type: () => Number }, cantidadDespues: { required: true, type: () => Number }, precioUnitario: { required: true, type: () => Number }, motivo: { required: true, type: () => String }, numeroDocumento: { required: true, type: () => String }, observaciones: { required: true, type: () => String }, origenTipo: { required: true, type: () => String }, origenId: { required: true, type: () => Number }, fechaMovimiento: { required: true, type: () => Date }, createdAt: { required: true, type: () => Date }, updatedAt: { required: true, type: () => Date }, inventario: { required: true, type: () => require("../../inventarios/entities/inventario.entity").Inventario }, inventarioId: { required: true, type: () => Number }, venta: { required: true, type: () => require("../../ventas/entities/venta.entity").Venta }, ventaId: { required: true, type: () => Number }, usuario: { required: true, type: () => require("../../usuarios/entities/usuario.entity").Usuario }, usuarioId: { required: true, type: () => Number } };
    }
};
