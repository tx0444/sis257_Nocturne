...
class CreateDetallesVentaDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { cantidad: { required: true, type: () => Number }, precioUnitario: { required: true, type: () => Number }, descuento: { required: false, type: () => Number }, ventaId: { required: true, type: () => Number }, productoId: { required: true, type: () => Number }, inventarioId: { required: true, type: () => Number }, numeroLote: { required: false, type: () => String }, observaciones: { required: false, type: () => String } };
    }
}
...
class UpdateDetallesVentaDto extends (0, swagger_1.PartialType)(CreateDetallesVentaDto) {
    static _OPENAPI_METADATA_FACTORY() {
        return {};
    }
}
