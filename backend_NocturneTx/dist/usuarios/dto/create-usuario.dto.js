...
class CreateUsuarioDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { nombre: { required: true, type: () => String }, email: { required: true, type: () => String, format: "email" }, password: { required: true, type: () => String }, telefono: { required: false, type: () => String }, direccion: { required: false, type: () => String }, fotoUrl: { required: false, type: () => String }, rolId: { required: true, type: () => Number } };
    }
}
