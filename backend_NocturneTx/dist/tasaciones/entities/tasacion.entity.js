...
let Tasacion = class Tasacion {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, producto: { required: true, type: () => require("../../productos/entities/producto.entity").Producto }, productoId: { required: true, type: () => Number }, valorTasacion: { required: true, type: () => Number }, tendencia: { required: true, type: () => String }, fechaTasacion: { required: true, type: () => Date } };
    }
};
