...
let AlertaSeguridad = class AlertaSeguridad {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, cliente: { required: true, type: () => require("../../clientes/entities/cliente.entity").Cliente }, clienteId: { required: true, type: () => Number }, tipoAlerta: { required: true, type: () => String }, mensaje: { required: true, type: () => String }, leido: { required: true, type: () => Boolean }, fechaAlerta: { required: true, type: () => Date } };
    }
};
